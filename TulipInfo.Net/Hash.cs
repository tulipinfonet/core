    ...
    public static class Hash
    {
        ...
        public static string MD5(byte[] input)
        {
            if (input == null || input.Length == 0)
                return "";
            HashAlgorithm algorithm = System.Security.Cryptography.MD5.Create();
            return Base64.UrlEncode(algorithm.ComputeHash(input));
        }
        public static string SHA256(string input)
        {
            ...
            return Base64.UrlEncode(algorithm.ComputeHash(Encoding.UTF8.GetBytes(input)));
        }
        ...
        /// </summary>
        private static uint[] crc32Table = { 0x00000000, 0x77073096, 0xee0e612c, 0x990951ba, 0x076dc419, 0x706af48f, 0xe963a535, 0x9e6495a3,
